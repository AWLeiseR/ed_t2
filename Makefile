...
siguel: main.o 
	$(CC) main.o figuras.o lista.o quadra.o radioBase.o hidrante.o geofile.o semaforo.o svgFile.o qryFile.o $(COMPILER_FLAGS) $(LINKER_FLAGS) -o $(OBJ_NAME)
...
qryFile.o: qryFile.c qryFile.h svgFile.o
	$(CC) -c qryFile.c
